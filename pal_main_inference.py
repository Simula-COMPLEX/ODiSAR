...
from config.config_inference_pal import (
    TEST_DATA_DIR,
    SCALER_PATH,
    MODEL_PATH,
    THRESHOLD_PATH,
...
from config.pal_config_train import MODEL_PARAMS

from models.pal_transformer_model import MergedForecastReconModel
...
combined_features = list(dict.fromkeys(INPUT_FEATURES + OUTPUT_FEATURES))
...
print('Recon thresh:', recon_thresh)
print('Var thresh:', var_thresh)
